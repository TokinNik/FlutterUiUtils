...
import com.flutter.ui.utils.flutteruiutils.ActionHelper.Companion.UNIT_TEST_PATH
...
class UiUtils : CreateFileFromTemplateAction(
    ...
    override fun buildDialog(project: Project, directory: PsiDirectory, builder: CreateFileFromTemplateDialog.Builder) {
        builder
                ...
                .addKind(MyBundle.message("list.item.dart-test.file"), DartIcons.Dart_test, "Tmp")
    }
